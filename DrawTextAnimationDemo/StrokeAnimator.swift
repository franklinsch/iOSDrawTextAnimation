...
func performStrokeAnimation(text text: String, font: CTFont, inView view: UIView) {
    performStrokeAnimation(text: text, font: font, characterSpacing: 20.0, wordSpacing: 40.0, duration: 1.0, borderWidth: 1.0, borderColor: UIColor.blackColor().CGColor, inView: view)
    
}

func performStrokeAnimation(text text: String, font: CTFont, characterSpacing: CGFloat, wordSpacing: CGFloat, duration: CFTimeInterval, borderWidth: CGFloat, borderColor: CGColor, inView view: UIView) {
...
func getGroupLayer(textGroup: String, font: CTFont, borderColor: CGColor, borderWidth: CGFloat, characterSpacing: CGFloat) -> CALayer {
...
func createViewFromLayers(layers: [CALayer], wordSpacing: CGFloat) -> UIView {
    let textView = UIView()
...
func getLetterHeight(font font: CTFont) -> CGFloat {
